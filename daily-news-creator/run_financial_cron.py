...
미 국채 2년 단기물은 +13bp 상승했으며,
**미 국채 10년은 +5bp 상승한 4.49%로 마감**했습니다.
...
- 미국 주요 경제 지표(PCE 물가 지수, CPI 등) 발표나 엔비디아, 애플 등 주요 빅테크 기업의 실적(어닝) 발표 등 굵직한 이벤트가 있는 날에는, 구글 검색을 활용하여 해당 내용과 증시에 미친 영향을 본문에 반드시 상세히 포함하십시오.
